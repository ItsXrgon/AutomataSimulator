...
public:
    StateNotFoundException(const std::string& stateKey)
...
public:
    InvalidAlphabetException(const std::string& msg)
        : FiniteAutomatonException("Invalid alphabet: " + msg) {
    }
};
...
public:
    InvalidStartStateException(const std::string& msg)
        : FiniteAutomatonException("Invalid start state: " + msg) {
    }
};
...
public:
    InvalidTransitionException(const std::string& msg)
        : FiniteAutomatonException("Invalid transition: " + msg) {
    }
};
