...
class NPDA_Test : public ::testing::Test {
  protected:
	void SetUp() override {
...
TEST_F(NPDA_Test, GetInput_GetsInput) {
	std::vector<std::string> input = automaton->getInput();
	EXPECT_EQ(input.size(), 0);
}

TEST_F(NPDA_Test, SetInput_SetsInput) {
...
TEST_F(NPDA_Test, SetInput_NoThrowForEpsilon) {
	EXPECT_NO_THROW(automaton->setInput({"0", "", "1"}));
}

TEST_F(NPDA_Test, SetInput_ThrowsForInputNotInAlphabet) {
	EXPECT_THROW(automaton->setInput({"a", "b"}), InputAlphabetSymbolNotFoundException);
}

TEST_F(NPDA_Test, SetInput_AddsNewInputs) {
...
TEST_F(NPDA_Test, AddInput_NoThrowForEpsilon) {
	EXPECT_NO_THROW(automaton->addInput({"0", "", "1"}));
}

TEST_F(NPDA_Test, AddInput_ThrowsForInputNotInAlphabet) {
	EXPECT_THROW(automaton->setInput({"a", "b"}), InputAlphabetSymbolNotFoundException);
}

TEST_F(NPDA_Test, StateExists_ReturnsTrueWhenStateExists) {
	EXPECT_TRUE(automaton->stateExists("q0"));
	EXPECT_TRUE(automaton->stateExists("q1"));
}

TEST_F(NPDA_Test, StateExists_ReturnsFalseWhenStateDoesNotExist) {
	EXPECT_FALSE(automaton->stateExists("q2"));
	EXPECT_FALSE(automaton->stateExists(""));
}

TEST_F(NPDA_Test, InputAlphabetSymbolExists_ReturnsTrueForValidSymbol) {
	EXPECT_TRUE(automaton->inputAlphabetSymbolExists("0"));
	EXPECT_TRUE(automaton->inputAlphabetSymbolExists("1"));
}

TEST_F(NPDA_Test, InputAlphabetSymbolExists_ReturnsFalseForInvalidSymbol) {
...
TEST_F(NPDA_Test, AddState_AddsNewStateSuccessfully) {
	automaton->addState("q2");
	EXPECT_TRUE(automaton->stateExists("q2"));
}

TEST_F(NPDA_Test, AddState_ThrowsForDuplicateState) {
...
TEST_F(NPDA_Test, AddState_AddsMultipleStates) {
	automaton->addState("q2");
...
TEST_F(NPDA_Test, AddState_AddsStateAsAccept) {
	automaton->addState("q2", true);
	EXPECT_TRUE(automaton->getState("q2").getIsAccept());
}

TEST_F(NPDA_Test, UpdateStateLabel_UpdatesStateLabel) {
...
TEST_F(NPDA_Test, UpdateStateLabel_UpdatesStartStateLabel) {
	automaton->updateStateLabel("q0", "q3");
	EXPECT_TRUE(automaton->getStartState() == "q3");
}

TEST_F(NPDA_Test, GetCurrentState_GetsStartStateIfNoCurrentStateSet) {
	EXPECT_TRUE(automaton->getCurrentState() == "q0");
}

TEST_F(NPDA_Test, GetCurrentState_ThrowsIfNoStartStateOrCurrentStateSet) {
...
TEST_F(NPDA_Test, GetStates_GetsStatesAfterAddStateCall) {
	automaton->addState("q3");
	std::vector<PDAState> states = automaton->getStates();
...
TEST_F(NPDA_Test, GetStates_GetsStatesAfterUpdateStateLabelCall) {
	automaton->updateStateLabel("q0", "q3");
	std::vector<PDAState> states = automaton->getStates();
...
TEST_F(NPDA_Test, RemoveState_RemovesState) {
...
TEST_F(NPDA_Test, RemoveState_RemovesStartState) {
...
TEST_F(NPDA_Test, RemoveState_RemovesCurrentState) {
...
TEST_F(NPDA_Test, RemoveState_ThrowsIfStateNotFound) {
	EXPECT_THROW(automaton->removeState("q3"), StateNotFoundException);
}

TEST_F(NPDA_Test, RemoveState_RemovesTransitionsWithStateAsToIfNotStrict) {
...
TEST_F(NPDA_Test, RemoveState_ThrowsIfStateIsUsedInTransitionsIfStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
	EXPECT_THROW(automaton->removeState("q0", true), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, RemoveStates_RemovesMultipleStates) {
	automaton->addState("q2");
	automaton->addState("q3");
...
TEST_F(NPDA_Test, RemoveStates_RemovesStartState) {
	automaton->removeStates({"q0", "q1"});
	EXPECT_THROW(automaton->getStartState(), InvalidStartStateException);
}

TEST_F(NPDA_Test, RemoveStates_RemovesCurrentState) {
	automaton->setCurrentState("q0");
	automaton->removeStates({"q0", "q1"});
	EXPECT_THROW(automaton->getCurrentState(), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, RemoveStates_ThrowsIfStateNotFound) {
	EXPECT_THROW(automaton->removeStates({"q1", "q2"}), StateNotFoundException);
}

TEST_F(NPDA_Test, RemoveStates_RemovesTransitionsWithStateAsToIfNotStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
...
TEST_F(NPDA_Test, RemoveStates_ThrowsIfStateIsUsedInTransitionsIfStrict) {
	automaton->setCurrentState("q0");
	automaton->addTransition("q1", "q0", "0", "A", "A");
	EXPECT_THROW(automaton->removeStates({"q0"}, true), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, ClearStates_RemovesAllStates) {
	EXPECT_TRUE(automaton->getStates().size() == 2);
	automaton->clearStates();
	EXPECT_TRUE(automaton->getStates().empty());
}

TEST_F(NPDA_Test, ClearStates_RemovesCurrentState) {
	automaton->clearStates();
	EXPECT_THROW(automaton->getCurrentState(), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, ClearStates_RemovesStartState) {
	automaton->clearStates();
	EXPECT_THROW(automaton->getStartState(), InvalidStartStateException);
}

TEST_F(NPDA_Test, GetInputAlphabet_GetsAlphabet) {
...
TEST_F(NPDA_Test, SetInputAlphabet_OverridesAlphabet) {
...
TEST_F(NPDA_Test, SetInputAlphabet_NoThrowForEpsilon) {
	EXPECT_NO_THROW(automaton->setInputAlphabet({"a", "", "c"}));
}

TEST_F(NPDA_Test, SetInputAlphabet_ThrowsForUsedSymbolIfStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
	EXPECT_THROW(automaton->setInputAlphabet({"a", "b"}, true), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, SetInputAlphabet_RemovesTransitionsWithOldSymbolIfNotStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
...
TEST_F(NPDA_Test, AddInputAlphabet_AddsNewSymbols) {
	automaton->addInputAlphabet({"2", "3"});
	std::vector<std::string> alphabet = automaton->getInputAlphabet();
...
TEST_F(NPDA_Test, AddInputAlphabet_ThrowsForEpsilon) {
	EXPECT_NO_THROW(automaton->addInputAlphabet({"a", "", "c"}));
}

TEST_F(NPDA_Test, AddInputAlphabet_IgnoresDuplicates) {
...
TEST_F(NPDA_Test, RemoveInputAlphabetSymbol_RemovesSymbol) {
...
TEST_F(NPDA_Test, RemoveInputAlphabetSymbol_ThrowsIfNotFound) {
	EXPECT_THROW(automaton->removeInputAlphabetSymbol("x"), InputAlphabetSymbolNotFoundException);
}

TEST_F(NPDA_Test, RemoveInputAlphabetSymbols_RemovesMultipleSymbols) {
	automaton->addInputAlphabet({"2", "3"});
...
TEST_F(NPDA_Test, RemoveInputAlphabetSymbol_ThrowsForUsedSymbolIfStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
	EXPECT_THROW(automaton->removeInputAlphabetSymbol("0", true), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, RemoveInputAlphabetSymbol_RemovesTransitionsWithOldSymbolIfNotStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
...
TEST_F(NPDA_Test, RemoveInputAlphabetSymbols_ThrowsIfAnySymbolNotFound) {
	automaton->addInputAlphabet({"2"});
	EXPECT_THROW(automaton->removeInputAlphabetSymbols({"1", "x"}), InputAlphabetSymbolNotFoundException);
}

TEST_F(NPDA_Test, RemoveInputAlphabetSymbols_ThrowsForUsedSymbolIfStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
	EXPECT_THROW(automaton->removeInputAlphabetSymbols({"0"}, true), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, RemoveInputAlphabetSymbols_RemovesTransitionsWithOldSymbolIfNotStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
...
TEST_F(NPDA_Test, ClearInputAlphabet_RemovesAllSymbols) {
	automaton->clearInputAlphabet();
	EXPECT_TRUE(automaton->getInputAlphabet().empty());
}

TEST_F(NPDA_Test, ClearInputAlphabet_ThrowsForUsedSymbolIfStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
	EXPECT_THROW(automaton->clearInputAlphabet(true), InvalidAutomatonDefinitionException);
}

TEST_F(NPDA_Test, ClearInputAlphabet_RemovesNonEpsilonTransitionsWithOldSymbolIfNotStrict) {
	automaton->addTransition("q1", "q0", "0", "A", "A");
...
TEST_F(NPDA_Test, GetStackAlphabet_GetsAlphabet) {
...
TEST_F(NPDA_Test, SetStackAlphabet_OverridesAlphabet) {
...
TEST_F(NPDA_Test, SetStackAlphabet_NoThrowForEpsilon) {
	EXPECT_NO_THROW(automaton->setStackAlphabet({"A", "", "C"}));
}

TEST_F(NPDA_Test, AddStackAlphabet_AddsNewSymbols) {
...
TEST_F(NPDA_Test, AddStackAlphabet_NoThrowForEpsilon) {
	EXPECT_NO_THROW(automaton->addStackAlphabet({"A", "", "C"}));
}

TEST_F(NPDA_Test, AddStackAlphabet_IgnoresDuplicates) {
...
TEST_F(NPDA_Test, RemoveStackAlphabetSymbol_RemovesSymbol) {
...
TEST_F(NPDA_Test, RemoveStackAlphabetSymbol_ThrowsIfNotFound) {
	EXPECT_THROW(automaton->removeStackAlphabetSymbol("X"), StackAlphabetSymbolNotFoundException);
}

TEST_F(NPDA_Test, RemoveStackAlphabetSymbols_RemovesMultipleSymbols) {
	automaton->addStackAlphabet({"B", "C"});
...
TEST_F(NPDA_Test, RemoveStackAlphabetSymbols_ThrowsIfAnySymbolNotFound) {
	automaton->addStackAlphabet({"B"});
	EXPECT_THROW(automaton->removeStackAlphabetSymbols({"B", "X"}), StackAlphabetSymbolNotFoundException);
}

TEST_F(NPDA_Test, ClearStackAlphabet_RemovesAllSymbols) {
	automaton->clearStackAlphabet();
	EXPECT_TRUE(automaton->getStackAlphabet().empty());
}

TEST_F(NPDA_Test, GetStartState_ReturnsCorrectState) {
	EXPECT_EQ(automaton->getStartState(), "q0");
}

TEST_F(NPDA_Test, GetStartState_ThrowsIfNotSet) {
	automaton->removeState("q0");
	EXPECT_THROW(automaton->getStartState(), InvalidStartStateException);
}

TEST_F(NPDA_Test, SetStartState_SetsNewStartState) {
	automaton->addState("q2");
	automaton->setStartState("q2");
	EXPECT_EQ(automaton->getStartState(), "q2");
}

TEST_F(NPDA_Test, SetStartState_ThrowsIfStateNotFound) {
	EXPECT_THROW(automaton->setStartState("q3"), StateNotFoundException);
}

TEST_F(NPDA_Test, SetStartState_SetsCurrentStateIfEmpty) {
	automaton->clearStates();
...
TEST_F(NPDA_Test, SetStartState_DoesNotOverrideCurrentStateIfSet) {
	automaton->addState("q2");
	automaton->setCurrentState("q1");
	automaton->setStartState("q2");
...
TEST_F(NPDA_Test, AddTransition_AddsValidTransition) {
...
TEST_F(NPDA_Test, AddTransition_ThrowsIfFromStateDoesNotExist) {
	EXPECT_THROW(automaton->addTransition("qX", "q1", "0", "A", "A"), StateNotFoundException);
}

TEST_F(NPDA_Test, AddTransition_ThrowsIfToStateDoesNotExist) {
	EXPECT_THROW(automaton->addTransition("q0", "qX", "0", "A", "A"), StateNotFoundException);
}

TEST_F(NPDA_Test, AddTransition_ThrowsIfInputNotInAlphabet) {
	EXPECT_THROW(automaton->addTransition("q0", "q1", "2", "A", "A"), InvalidTransitionException);
}

TEST_F(NPDA_Test, AddTransition_NoThrowsIfEpsilonInDPDA) {
	EXPECT_NO_THROW(automaton->addTransition("q0", "q1", "", "A", "A"));
}

TEST_F(NPDA_Test, AddTransition_NoThrowIfNonDeterministic) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	EXPECT_NO_THROW(automaton->addTransition("q0", "q2", "0", "A", "A"));
}

TEST_F(NPDA_Test, AddTransition_AllowsDifferentInputs) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, AddTransition_DoesNotInvalidateExistingTransitions) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionInput_ValidUpdate) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionInput_DoesNotInvalidateOtherTransitions) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionInput_ThrowsIfInputNotInAlphabet) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionInput_ThrowsIfTransitionExists) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionInput_ThrowsIfTransitionNotFound) {
	EXPECT_THROW(automaton->updateTransitionInput("invalidKey", "1"), TransitionNotFoundException);
}

TEST_F(NPDA_Test, UpdateTransitionInput_NoThrowIfNonDeterministic) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q2", "1", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionFromState_ValidUpdate) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionFromState_ThrowsIfDuplicate) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionFromState_ThrowsIfTransitionNotFound) {
	automaton->addState("q2");
	EXPECT_THROW(automaton->updateTransitionFromState("invalidKey", "q2"), TransitionNotFoundException);
}

TEST_F(NPDA_Test, UpdateTransitionFromState_NoThrowIfNonDeterministic) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionToState_ValidUpdate) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionToState_ThrowsIfStateNotFound) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionToState_ThrowsIfTransitionNotFound) {
	EXPECT_THROW(automaton->updateTransitionToState("invalidKey", "q2"), TransitionNotFoundException);
}

TEST_F(NPDA_Test, UpdateTransitionToState_DoesNotInvalidateOtherTransitions) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q1", "1", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionStackSymbol_ValidUpdate) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
	std::string transitionKey = PDATransition::generateTransitionKey("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionStackSymbol_DoesNotInvalidateOtherTransitions) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q2", "1", "A", "A");
	automaton->addInputAlphabet({"2"});
...
TEST_F(NPDA_Test, UpdateTransitionStackSymbol_ThrowsIfStackSymbolNotInAlphabet) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionStackSymbol_ThrowsIfTransitionExists) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q1", "1", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionStackSymbol_ThrowsIfTransitionNotFound) {
	EXPECT_THROW(automaton->updateTransitionStackSymbol("invalidKey", "1"), TransitionNotFoundException);
}

TEST_F(NPDA_Test, UpdateTransitionStackSymbol_NoThrowIfNonDeterministic) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	...
	EXPECT_NO_THROW(automaton->updateTransitionStackSymbol(transitionKey, "A"));
}

TEST_F(NPDA_Test, UpdateTransitionPushSymbol_ValidUpdate) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
	std::string transitionKey = PDATransition::generateTransitionKey("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionPushSymbol_DoesNotInvalidateOtherTransitions) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q2", "1", "A", "A");
	automaton->addInputAlphabet({"2"});
...
TEST_F(NPDA_Test, UpdateTransitionPushSymbol_ThrowsIfPushSymbolNotInAlphabet) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionPushSymbol_ThrowsIfTransitionExists) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q1", "1", "A", "A");
...
TEST_F(NPDA_Test, UpdateTransitionPushSymbol_ThrowsIfTransitionNotFound) {
	EXPECT_THROW(automaton->updateTransitionPushSymbol("invalidKey", "1"), TransitionNotFoundException);
}

TEST_F(NPDA_Test, RemoveTransition_RemovesValidTransition) {
	automaton->addTransition("q0", "q1", "0", "A", "A");
...
TEST_F(NPDA_Test, RemoveTransition_ThrowsIfTransitionNotFound) {
...
TEST_F(NPDA_Test, ClearTransitionsBetween_RemovesTransitions) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q2", "1", "A", "A");
...
TEST_F(NPDA_Test, ClearTransitionsBetween_ThrowsIfStateNotFound) {
	EXPECT_THROW(automaton->clearTransitionsBetween("qX", "qY"), StateNotFoundException);
}

TEST_F(NPDA_Test, ClearStateTransitions_RemovesAllTransitionsFromState) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q2", "1", "A", "A");
...
TEST_F(NPDA_Test, ClearStateTransitions_ThrowsIfStateNotFound) {
	EXPECT_THROW(automaton->clearStateTransitions("qX"), StateNotFoundException);
}

TEST_F(NPDA_Test, ClearTransitions_RemovesAllTransitions) {
	automaton->addState("q2");
	automaton->addTransition("q0", "q1", "0", "A", "A");
	automaton->addTransition("q0", "q2", "1", "A", "A");
	automaton->addTransition("q1", "q0", "0", "A", "A");
...
TEST_F(NPDA_Test, AddAcceptState_ValidState) {
...
TEST_F(NPDA_Test, AddAcceptState_DuplicateAcceptState) {
	automaton->addAcceptState("q1");
	automaton->addAcceptState("q1");
...
TEST_F(NPDA_Test, AddAcceptState_ThrowsIfStateNotFound) {
	EXPECT_THROW(automaton->addAcceptState("qX"), StateNotFoundException);
}

TEST_F(NPDA_Test, RemoveAcceptState_ValidState) {
	automaton->addAcceptState("q1");
...
TEST_F(NPDA_Test, RemoveAcceptState_NonAcceptState) {
	automaton->addAcceptState("q1");
...
TEST_F(NPDA_Test, AddAcceptStates_AddsMultipleAcceptStates) {
	automaton->addState("q2");
...
TEST_F(NPDA_Test, RemoveAcceptState_ThrowsIfStateNotFound) {
...
TEST_F(NPDA_Test, RemoveAcceptStates_ThrowsForMissingStates) {
	automaton->addState("q2");
	automaton->addAcceptStates({"q1", "q2"});
...
TEST_F(NPDA_Test, ClearAcceptStates_RemovesAllAcceptStates) {
...
TEST_F(NPDA_Test, ClearAcceptStates_NoAcceptStates) {
	automaton->clearAcceptStates();
...
TEST_F(NPDA_Test, GetAcceptStates_ReturnsAllAcceptStates) {
	automaton->addAcceptState("q0");
	automaton->addAcceptState("q1");
...
TEST_F(NPDA_Test, GetAcceptStates_EmptyIfNoAcceptStates) {
	auto acceptStates = automaton->getAcceptStates();
	EXPECT_TRUE(acceptStates.empty());
}

TEST_F(NPDA_Test, Reset_SetsCurrentStateToStartState) {
	automaton->addAcceptState("q0");
	automaton->reset();
...
TEST_F(NPDA_Test, Reset_HandlesAcceptStartState) {
	automaton->addAcceptState("q0");
	automaton->reset();
...
TEST_F(NPDA_Test, IsAccepting_ShouldAcceptIfStartStateIsAccept) {
	automaton->addAcceptState("q0");
	EXPECT_TRUE(automaton->isAccepting());
}

TEST_F(NPDA_Test, IsAccepting_ShouldAcceptIfCurrentStateIsAccept) {
	automaton->addAcceptState("q1");
	automaton->setCurrentState("q1");
	EXPECT_TRUE(automaton->isAccepting());
}

TEST_F(NPDA_Test, ProcessInput_ShouldUpdateCurrentState) {
	automaton->addState("q2");
	automaton->addState("q3");
	automaton->addAcceptState("q3");
	automaton->addStackAlphabet({"0", "1"});

	automaton->addTransition("q0", "q1", "", "", "Z");

	automaton->addTransition("q1", "q1", "0", "", "0");
	automaton->addTransition("q1", "q1", "1", "", "1");
	automaton->addTransition("q1", "q2", "", "", "");

	automaton->addTransition("q2", "q2", "0", "0", "");
	automaton->addTransition("q2", "q2", "1", "1", "");
	automaton->addTransition("q2", "q3", "", "Z", "");

	automaton->setInput({"0", "1", "1", "0"});
}

TEST_F(NPDA_Test, ProcessInput_ShouldStayAcceptingAfterInputIsConsumed) {
	automaton->addState("q2");
	automaton->addState("q3");
	automaton->addAcceptState("q3");
	automaton->addStackAlphabet({"0", "1"});
...
TEST_F(NPDA_Test, Simulate_ShouldThrowExceptionForSimulationWithoutStartState) {
