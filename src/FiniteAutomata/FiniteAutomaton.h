...
class AUTOMATASIMULATOR_API FiniteAutomaton {
  ...
  public:
	 ...
	 */
	std::vector<FAState> getStates() const;
	 ...
	 */
	virtual void setInputAlphabet(const std::set<std::string> &inputAlphabet);
	 ...
	 * @throws InvalidTransitionException If the transition violates automaton constraints.
	 */
	virtual void addTransitionBetween(const std::string &fromStateKey, const std::string &input,
